    ...
    def __getitem__(self, idx):
        ...
        if self.frame_arr is not None:
            ...
            if self.frame_alpha > 0:
                ...
                # Use copy to avoid in-place modification of self.data_dict
                tmp_coor = tmp_coor.copy()
            ...
            # Normalization (Use copy to avoid in-place modification of self.data_dict)
            coor = coor.copy()
            coor_pred = coor_pred.copy()
